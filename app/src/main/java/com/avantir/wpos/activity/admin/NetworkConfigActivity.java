...
public class NetworkConfigActivity extends BaseActivity implements  View.OnFocusChangeListener{
    ...
    protected void initView() {
        ...
        ((EditText) findViewById(R.id.terminalIdText)).setOnFocusChangeListener(this);
    ...
    protected void initData() {
        ...
        EditText terminalIdEditText = (EditText) findViewById(R.id.terminalIdText);
        terminalIdEditText.setText(globalData.getTerminalId(), TextView.BufferType.EDITABLE);
    ...
    private void saveHostData(){
        try{
            String terminalId = ((EditText) findViewById(R.id.terminalIdText)).getText().toString();
