...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Download terminal params
        //JobUtils.scheduleCallHomeJob(this);
        //JobUtils.scheduleDownloadKeysJob(this);

        // before doing trxn ensure, terminal params (Term param, AID, EMV has been downloaded)
        // before calling home, ensure term params av been downloaded
        // before downloading keys (Master key, session key, Pin key) ensure CTMK has been loaded
        // before downloading IPEKs (Track 2 & EMV), ensure BDK has been loaded
    }
