    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case  ConstantUtils.MSG_FINISH_ERROR_COMMS:
                ...
                String paramString = bundleFail.getString(String.valueOf(ConstantUtils.MSG_FINISH_ERROR_COMMS_MSG));
                showToast("Comms error! (" + commsErrorCode + ")");
                //showToast("Comms error! (" + commsErrorCode + ")\n" + paramString);
    ...
    private void processTMSTermParamResponse(String response){
        try{
            ...
            if(parameter != null && parameter.getCtmk() != null && !parameter.getCtmk().isEmpty()) {
                ...
                if(globalData.getIfFirstLaunch() || !parameter.isUseLocalNetworkConfig()){
                ...
                globalData.setTransactionNotificationRetryTimeInMin(parameter.getTransNotifyRetryTimeInMin());
                globalData.setReversalRetryTimeInMin(parameter.getReversalRetryTimeInMin());
                globalData.setTranNotifyRetentionInDays(parameter.getTranNotifyRetentionInDays());
                globalData.setReversalRetentionInDays(parameter.getReversalRetentionInDays());
