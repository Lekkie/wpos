...
public class ConstantUtils {
    ...
    public static HashMap<String, String> RSP_CODE_MSG_MAP = new HashMap<>();
    static{
        RSP_CODE_MSG_MAP.put(	"00"	,	"Approved or completed successfully"	);
        RSP_CODE_MSG_MAP.put(	"01"	,	"Refer to card issuer"	);
        RSP_CODE_MSG_MAP.put(	"02"	,	"Refer to card issuer, special condition"	);
        RSP_CODE_MSG_MAP.put(	"03"	,	"Invalid merchant"	);
        RSP_CODE_MSG_MAP.put(	"04"	,	"Pick-up card"	);
        RSP_CODE_MSG_MAP.put(	"05"	,	"Do not honor"	);
        RSP_CODE_MSG_MAP.put(	"06"	,	"Error"	);
        RSP_CODE_MSG_MAP.put(	"07"	,	"Pick-up card, special condition"	);
        RSP_CODE_MSG_MAP.put(	"08"	,	"Honor with identification"	);
        RSP_CODE_MSG_MAP.put(	"09"	,	"Request in progress"	);
        RSP_CODE_MSG_MAP.put(	"10"	,	"Approved, partial"	);
        RSP_CODE_MSG_MAP.put(	"11"	,	"Approved, VIP"	);
        RSP_CODE_MSG_MAP.put(	"12"	,	"Invalid transaction"	);
        RSP_CODE_MSG_MAP.put(	"13"	,	"Invalid amount"	);
        RSP_CODE_MSG_MAP.put(	"14"	,	"Invalid card number"	);
        RSP_CODE_MSG_MAP.put(	"15"	,	"No such issuer"	);
        RSP_CODE_MSG_MAP.put(	"16"	,	"Approved, update track 3"	);
        RSP_CODE_MSG_MAP.put(	"17"	,	"Customer cancellation"	);
        RSP_CODE_MSG_MAP.put(	"18"	,	"Customer dispute"	);
        RSP_CODE_MSG_MAP.put(	"19"	,	"Re-enter transaction"	);
        RSP_CODE_MSG_MAP.put(	"20"	,	"Invalid response"	);
        RSP_CODE_MSG_MAP.put(	"21"	,	"No action taken"	);
        RSP_CODE_MSG_MAP.put(	"22"	,	"Suspected malfunction"	);
        RSP_CODE_MSG_MAP.put(	"23"	,	"Unacceptable transaction fee"	);
        RSP_CODE_MSG_MAP.put(	"24"	,	"File update not supported"	);
        RSP_CODE_MSG_MAP.put(	"25"	,	"Unable to locate record"	);
        RSP_CODE_MSG_MAP.put(	"26"	,	"Duplicate record"	);
        RSP_CODE_MSG_MAP.put(	"27"	,	"File update field edit error"	);
        RSP_CODE_MSG_MAP.put(	"28"	,	"File update file locked"	);
        RSP_CODE_MSG_MAP.put(	"29"	,	"File update failed"	);
        RSP_CODE_MSG_MAP.put(	"30"	,	"Format error"	);
        RSP_CODE_MSG_MAP.put(	"31"	,	"Bank not supported"	);
        RSP_CODE_MSG_MAP.put(	"32"	,	"Completed partially"	);
        RSP_CODE_MSG_MAP.put(	"33"	,	"Expired card, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"34"	,	"Suspected fraud, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"35"	,	"Contact acquirer, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"36"	,	"Restricted card, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"37"	,	"Call acquirer security, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"38"	,	"PIN tries exceeded, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"39"	,	"No credit account"	);
        RSP_CODE_MSG_MAP.put(	"40"	,	"Function not supported"	);
        RSP_CODE_MSG_MAP.put(	"41"	,	"Lost card, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"42"	,	"No universal account"	);
        RSP_CODE_MSG_MAP.put(	"43"	,	"Stolen card, pick-up"	);
        RSP_CODE_MSG_MAP.put(	"44"	,	"No investment account"	);
        RSP_CODE_MSG_MAP.put(	"45"	,	"Account closed"	);
        RSP_CODE_MSG_MAP.put(	"46"	,	"Identification required"	);
        RSP_CODE_MSG_MAP.put(	"47"	,	"Identification cross-check required"	);
        RSP_CODE_MSG_MAP.put(	"51"	,	"Not sufficient funds"	);
        RSP_CODE_MSG_MAP.put(	"52"	,	"No check account"	);
        RSP_CODE_MSG_MAP.put(	"53"	,	"No savings account"	);
        RSP_CODE_MSG_MAP.put(	"54"	,	"Expired card"	);
        RSP_CODE_MSG_MAP.put(	"55"	,	"Incorrect PIN"	);
        RSP_CODE_MSG_MAP.put(	"56"	,	"No card record"	);
        RSP_CODE_MSG_MAP.put(	"57"	,	"Transaction not permitted to cardholder"	);
        RSP_CODE_MSG_MAP.put(	"58"	,	"Transaction not permitted on terminal"	);
        RSP_CODE_MSG_MAP.put(	"59"	,	"Suspected fraud"	);
        RSP_CODE_MSG_MAP.put(	"60"	,	"Contact acquirer"	);
        RSP_CODE_MSG_MAP.put(	"61"	,	"Exceeds withdrawal limit"	);
        RSP_CODE_MSG_MAP.put(	"62"	,	"Restricted card"	);
        RSP_CODE_MSG_MAP.put(	"63"	,	"Security violation"	);
        RSP_CODE_MSG_MAP.put(	"64"	,	"Original amount incorrect"	);
        RSP_CODE_MSG_MAP.put(	"65"	,	"Exceeds withdrawal frequency"	);
        RSP_CODE_MSG_MAP.put(	"66"	,	"Call acquirer security"	);
        RSP_CODE_MSG_MAP.put(	"67"	,	"Hard capture"	);
        RSP_CODE_MSG_MAP.put(	"68"	,	"Response received too late"	);
        RSP_CODE_MSG_MAP.put(	"69"	,	"Advice received too late"	);
        RSP_CODE_MSG_MAP.put(	"75"	,	"PIN tries exceeded"	);
        RSP_CODE_MSG_MAP.put(	"76"	,	"Reserved for future Postilion use"	);
        RSP_CODE_MSG_MAP.put(	"77"	,	"Intervene, bank approval required"	);
        RSP_CODE_MSG_MAP.put(	"78"	,	"Intervene, bank approval required for partial amount"	);
        RSP_CODE_MSG_MAP.put(	"90"	,	"Cut-off in progress"	);
        RSP_CODE_MSG_MAP.put(	"91"	,	"Issuer or switch inoperative"	);
        RSP_CODE_MSG_MAP.put(	"92"	,	"Routing error"	);
        RSP_CODE_MSG_MAP.put(	"93"	,	"Violation of law"	);
        RSP_CODE_MSG_MAP.put(	"94"	,	"Duplicate transaction"	);
        RSP_CODE_MSG_MAP.put(	"95"	,	"Reconcile error"	);
        RSP_CODE_MSG_MAP.put(	"96"	,	"System malfunction"	);
    }
    ...
    public static String[] CAPK_DATA = {
            ...
            "",
            "",
            ""
    };
